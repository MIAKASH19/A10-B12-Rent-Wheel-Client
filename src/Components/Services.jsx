...
const Services = () => {
  return (
    <div className=" w-full min-h-screen px-10 py-20 text-zinc-750">
      ...
      >
        ...
        <div className='relative group w-100 h-70 overflow-hidden shadow-2xl rounded-3xl px-5 py-7 bg-[url("https://img.freepik.com/free-photo/young-couple-choosing-car-car-showroom_1303-22834.jpg?semt=ais_hybrid&w=740&q=80")] bg-cover'>
        ...
        <div className='relative group w-100 h-70 overflow-hidden shadow-2xl rounded-3xl px-5 py-7 bg-[url("https://img.freepik.com/free-photo/young-woman-testing-car-from-car-showroom_1303-17398.jpg?semt=ais_hybrid&w=740&q=80")] bg-cover'>
          <span className="bg-white group-hover:bg-black group-hover:text-white transition-all duration-300 rounded-full py-3 px-5 text-sm">
            Self Drive Options
          </span>
