...
const CarCard = ({ car }) => {
  return (
    ...
    >
      <div className="bg-zinc-800 relative w-full h-46 rounded-3xl overflow-hidden">
      ...
      <div className="mt-3 px-2">
        ...
        <div className="flex items-center justify-between">
          ...
          <Link
            ...
            className="bg-[#9fcc51]  text-sm flex items-center gap-2 py-2 px-8 text-white rounded-full"
          >
            View Details
